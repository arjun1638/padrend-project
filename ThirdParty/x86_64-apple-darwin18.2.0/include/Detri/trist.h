 ...
 *       in the 2nd case, 36 bytes, and MAX_ORG (in trist.c) == INT_MAX. */
...
#define trist_for(T)    upfor (T, 1, trist_last ()) if (! trist_deleted (T))
...
void trist_resize_hook (void (* hook) (int));
...
void trist_search_set_n (int enn);
